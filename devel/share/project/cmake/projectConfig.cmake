...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/shallowblue/Project/src/project)
  set(project_DEVEL_PREFIX /home/shallowblue/Project/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/shallowblue/Project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'shallowblue <shallowblue@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shallowblue/Project/src/project/${idir}'.  Ask the maintainer 'shallowblue <shallowblue@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shallowblue/Project/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
